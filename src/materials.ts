...
export const MATERIALS: Record<string, Material> = {
  ...
  steel: {
    ...
    si: {
      ...
      oxA0: 6e-6, oxQ: 170e3,
      s0: 70, kHP: 0.6,
      twinNote: "modeled as BCC δ-ferrite: annealing twins are an austenite (FCC) phenomenon, and there is no γ phase",
  ...
  scn: {
    ...
    si: {
      ...
      oxA0: 0, oxQ: 0,
      s0: 0.1, kHP: 0.001,
      twinNote: "freezes BCC (a plastic crystal): annealing twins are essentially an FCC phenomenon, rare in BCC",
