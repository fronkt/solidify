...
// (molten pour), 0 = mold. The band sits in the vertical middle of the square
// grid; a wide banner canvas cover-crops to exactly that band.
...
export function buildLogoMask(n: number, bandFrac = 0.24, word = "SOLIDIFY"): LogoMask {
  ...
  const img = ctx.getImageData(0, 0, n, bandH).data;
