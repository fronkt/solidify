...
export const MATERIALS: Record<string, Material> = {
  ...
  ni: {
    ...
    si: {
      ...
      oxA0: 3e-8, oxQ: 200e3,
      s0: 200, kHP: 0.75,
      source: "Ni–Nb as the superalloy proxy — niobium is the element that actually segregates in IN718. Chromia-forming, so oxidation is slow.",
    },
  },
  co: {
    label: "cobalt alloy",
    ...
    si: {
      ...
      oxA0: 5e-8, oxQ: 190e3,
      s0: 220, kHP: 0.7,
      source: "Generic dilute Co-base alloy. The least well characterised entry here — the solute numbers are order-of-magnitude, not a specific system.",
    },
  },
  cu: {
    label: "copper · bronze",
    ...
    si: {
      ...
      oxA0: 2e-6, oxQ: 150e3,
      s0: 25, kHP: 0.11,
      source: "Cu–Sn (bronze). The Cu–Sn liquidus is strongly curved toward the peritectic, so mL here is the dilute-limit slope, not an average over the range.",
    },
  },
  mg: {
